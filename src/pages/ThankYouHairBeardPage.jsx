...
const UPSELL_LINK = "https://rzp.io/rzp/OC9TDdoC"
const SUPPORT_PHONE = "+919814508715"
const TIMER_KEY = "upsell_expiry_hair-beard"

const OWNED = ["Hair Fixed", "Beard Maxxed"]
const ADDING = "Height Maxxed"
        ...
        <div style={{ maxWidth: 540, margin: "0 auto", padding: "52px 20px 88px" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <p style={{ color: "#A1A1AA", fontSize: 16, lineHeight: 1.6, margin: 0 }}>
              Your{" "}
              <span style={{ color: "#F5F5F5", fontWeight: 600 }}>Hair Fixed + Beard Maxxed</span>
          ...
          <div style={{
            ...
            <p style={{ color: "#A1A1AA", fontSize: 15, lineHeight: 1.65, margin: "0 0 24px" }}>
              You have hair and beard sorted. Most guys add height within a week anyway — skip the second trip.
            </p>
